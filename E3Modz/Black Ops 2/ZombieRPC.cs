...

{
    ...
    public class ZombieRPC

    {
        public static PS3API PS5 = (Zombies.PS3);
        private static uint function_address = 0x3D00E8;
...

        {
            ...
            BO2RPC.Call(0x5A657C, client, text);
...

        {
            ...
            BO2RPC.Call(0x5A657C, 0, Command);
