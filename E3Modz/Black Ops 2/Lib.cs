...
namespace E3Modz
{
    public class Lib
    {
        ...
        {
            byte[] memory = PS5.GetMemory(address, 4);
        ...
        {
            return (sbyte)PS5.GetMemory(address, 1)[0];
        }
        public static sbyte[] ReadSBytes(uint address, int length)
        {
            byte[] memory = PS5.GetMemory(address, length);
        ...
        public static string ReadString(uint address)
        {
            ...
            do
            {
                byte[] memory = PS5.GetMemory(address + (uint)num2, num);
        ...
        public static void WriteBool(uint address, bool input)
        {
            ...
            PS5.SetMemory(address, bytes);
        }
        public static void WriteByte(uint address, byte input)
        {
            PS5.SetMemory(address, new byte[]
            {
                input
            });
        }
