...
namespace PS3Lib
{
    ...
    public class PS3API
    {
        ...
        public void BlockMemory(uint offset, byte[] buffer)
        {
            if (SetAPI.API == SelectAPI.TargetManager)

                Common.TmApi.BlockMemory(offset, buffer);
            else if (SetAPI.API == SelectAPI.ControlConsole)
        ...
        internal void BlockMemory(object allChangeMemory, byte[] array1)
        {
